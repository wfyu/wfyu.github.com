...
{
	var unit_id     = "2785323";
	var client_ip   = "58.205.221.190";
	var server_time = "1359274253";
	var verify_code = "bce25174";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2785323/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
